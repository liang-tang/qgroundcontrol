...
public:
    ...
    //new add data
    Q_PROPERTY(Fact* windAngle  READ windAngle  CONSTANT)
    Q_PROPERTY(Fact* sensorHor  READ sensorHor  CONSTANT)
    Q_PROPERTY(Fact* sensorVer  READ sensorVer  CONSTANT)
    ...
    Q_PROPERTY(Fact* windvane_speed_horiz_sensor READ windvane_speed_horiz_sensor  CONSTANT)
    Q_PROPERTY(Fact* windvane_angle_horiz_sensor READ windvane_angle_horiz_sensor  CONSTANT)
    Q_PROPERTY(Fact* windvane_speed_vert_sensor READ windvane_speed_vert_sensor  CONSTANT)
    Q_PROPERTY(Fact* windvane_angle_vert_sensor READ windvane_angle_vert_sensor  CONSTANT)
    ...
    Fact* windAngle (void) { return &_windAngleFact; }
    Fact* sensorHor (void) { return &_sensorHorFact; }
    Fact* sensorVer (void) { return &_sensorVerFact; }
    ...
    Fact* windvane_speed_horiz_sensor(void) { return &_windvane_speed_horiz_sensorFact; }
    Fact* windvane_angle_horiz_sensor(void) { return &_windvane_angle_horiz_sensorFact; }
    Fact* windvane_speed_vert_sensor(void) { return &_windvane_speed_vert_sensorFact; }
    Fact* windvane_angle_vert_sensor(void) { return &_windvane_angle_vert_sensorFact; }
    ...
    static const char* _windAngleFactName;
    static const char* _sensorHorFactName;
    static const char* _sensorVerFactName;
...
private:
    ...
    Fact _windvane_speed_horiz_sensorFact;
    Fact _windvane_angle_horiz_sensorFact;
    Fact _windvane_speed_vert_sensorFact;
    Fact _windvane_angle_vert_sensorFact;
...
private:
    ...
    static const char*  _windvane_speed_horiz_sensorFactName;
    static const char*  _windvane_angle_horiz_sensorFactName;
    static const char*  _windvane_speed_vert_sensorFactName;
    static const char*  _windvane_angle_vert_sensorFactName;
